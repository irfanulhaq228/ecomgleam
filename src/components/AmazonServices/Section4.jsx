...
import img3 from "../../assets/imgs/About-section-4-img-3.png";
import img4 from "../../assets/imgs/About-section-4-img-4.png";
  ...
  return (
    <div className="flex flex-col gap-[30px] xl:gap-[50px] items-center justify-center mt-[70px]">
      <div className="mt-[40px] flex-1 w-[95%] xl:w-[1200px] flex flex-col xl:flex-row items-center xl:items-start justify-center gap-[30px] xl:gap-[50px]">
        <div
          className="max-w-[366px] xl:min-w-[auto] xl:flex-1 flex flex-col gap-[20px] items-center rounded-[12px] pt-[35px] px-[15px] sm:px-[40px] xl:h-[433px] text-[30px] xl:text-[70px] font-[800] justify-center"
        >
          <p className="mt-[-20px] uppercase">Why Choose Us</p>
        </div>
        <div data-aos="fade-up" data-aos-duration="1000" className="max-w-[366px] xl:min-w-[auto] transition-all duration-300 hover:scale-[1.03] xl:flex-1 flex flex-col gap-[20px] rounded-[12px] px-[15px] xl:h-[433px]">
