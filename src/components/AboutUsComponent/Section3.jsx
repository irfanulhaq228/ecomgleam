  ...
  return (
    <div className="flex justify-center">
      <div className="w-[95%] xl:w-[1050px] flex flex-col xl:flex-row gap-[30px] xl:gap-[50px]">
        <div data-aos="fade-up" data-aos-duration="1000" className="w-full bg-[--main-color] rounded-[12px] shadow-md px-[20px] py-[30px] flex flex-col items-center text-white gap-[10px]">
