  ...
  return (
    <div className="flex flex-col gap-[50px] items-center mb-[40px]">
      ...
      <div className="flex flex-col gap-[25px] w-full xl:w-[max-content] xl:flex-row justify-center items-center">
        <div className="min-w-[95%] xl:min-w-[280px] min-h-[100px] xl:min-h-[290px] xl:max-w-[280px] xl:max-h-[290px] rounded-[12px] flex justify-center items-center uppercase text-[25px] xl:text-[35px] p-[16px] leading-8 text-center font-[700] text-[--main-heading-color]">
