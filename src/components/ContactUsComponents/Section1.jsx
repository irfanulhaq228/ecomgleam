    ...
    <div className="flex justify-center mt-[60px]">
      <div className="w-[95%] xl:w-[1200px] flex flex-col lg:flex-row justify-center gap-[40px]">
        ...
        <div className="w-full" data-aos="fade-right" data-aos-duration="1000">
          <p className="text-2xl sm:text-3xl lg:w-[300px] md:text-4xl font-bold text-start uppercase text-[--main-heading-color] mb-[25px]">
          ...
          <img src={img} className="lg:w-[500px] mt-[20px] mb-[10px]" />
        ...
        {/* form */}
        <div data-aos="flip-left" data-aos-duration="1000" className="w-full">
          <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-start uppercase text-[--main-heading-color] mb-[15px]">
