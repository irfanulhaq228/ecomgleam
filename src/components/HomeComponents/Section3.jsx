...
const Section3 = () => {
  return (
    <div className="mt-[45px] lg:mt-[220px] xl:px-[140px] flex items-center justify-center">
      <div
      ...
      >
        ...
        <div className="flex flex-col gap-[20px] items-center">
          <p className="uppercase text-[25px] sm:text-[33px] lg:text-[37px] xl:text-[48px] font-[900] text-[--main-heading-color] text-center leading-[30px] sm:leading-[40px] xl:leading-[50px]">
