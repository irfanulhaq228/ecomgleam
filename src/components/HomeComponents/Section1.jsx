...
import video from "../../assets/videos/Home-cover-video.gif";
...
const Section1 = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="flex flex-col lg:flex-row gap-8 sm:gap-14 lg:gap-10 pt-5 sm:pt-8 items-center lg:items-center justify-center overflow-x-hidden"
    >
      <header
        ref={contentRef}
      ...
      >
        <h1 className="uppercase text-[25px] sm:text-[30px] lg:text-[35px] xl:text-[40px] font-[800] sm:font-[900] text-[--main-heading-color] leading-snug text-center lg:text-start max-w-[600px]">
        ...
        <div className="mt-[25px] lg:mt-[30px] flex justify-center gap-4 max-w-[600px]">
          <button
      ...
      >
        {/* <video
          ...
          muted
          playsInline
          className="object-contain min-w-[400px]"
        /> */}
        <img src={video} className="object-contain max-h-[500px]" alt="Ecommerce management" />
      </div>
    </section>
  );
};
